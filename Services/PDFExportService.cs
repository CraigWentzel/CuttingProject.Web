                    ...
                    page.Content().PaddingTop(12).Table(table =>
                    {
                        ...
                        foreach (IGrouping<string, StockBin> group in grouped)
                        {
                            ...
                            foreach (StockBin bin in group)
                            {
                                ...
                                table.Cell()
                                    .Background(bg).Padding(4).AlignCenter()
